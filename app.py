...
def find_route():
    ...
    if not start or not end:
        return jsonify({'error': 'Please select both starting point and destination'}), 400
    
    if start == end:
        return jsonify({'error': 'Starting point and destination cannot be the same'}), 400
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Please make sure 'bus_data.json' and 'places.txt' are in the correct locations")
